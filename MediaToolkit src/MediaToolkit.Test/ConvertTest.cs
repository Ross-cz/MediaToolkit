...
namespace MediaToolkit.Test
{
	...
	public class ConvertTest
	{
		...
		public void Can_GetMetadata()
		{
			...
			Debug.Assert(inputMeta.VideoData.Width > 0, "Width is invalid", "    Likely due to Regex code");
			Debug.Assert(inputMeta.VideoData.Height > 0, "Height is invalid", "    Likely due to Regex code");
